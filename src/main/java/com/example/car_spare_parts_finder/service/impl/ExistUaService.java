...
import com.example.car_spare_parts_finder.helper.*;
...
import com.example.car_spare_parts_finder.string_enum.HttpHeaderNameHolder;
import com.example.car_spare_parts_finder.string_enum.WordAndPunctuationHolder;
    ...
    public List<SparePart> extractSpareParts(JsonNode jsonNode) {
        ...
        try {
            for (JsonNode node : jsonNode) {
                if (node.path(BusinessNameHolder.PRAG_ID.getPath()).asText().equals(WordAndPunctuationHolder.NULL.getPath())) continue;
